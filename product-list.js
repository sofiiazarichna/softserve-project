(function () {
    ...
    function renderProduct(productId, htmlId) {
        const productsContainer = document.querySelector(htmlId);
        productsContainer.innerHTML = `
                <div class="shop-item centered-horizontally">
                    <img src="${product[id-19].imgUrl}" alt="${product[id-19].imgAlt}" class="shop-item-img responsive" />
                    <h5 class="shop-item-h5">${product[id-19].name}</h5>
                    <h3 class="shop-item-h3">$${product[id-19].price}</h3>
