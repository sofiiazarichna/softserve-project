(function () {
    ...
    function renderProduct(productId, htmlId) {
        document.getElementById(htmlId).innerHTML +=
            ...
            /*`
                <div class="shop-item centered-horizontally">
                    <img src="${products[id].imgUrl}" alt="${products[id].imgAlt}" class="shop-item-img responsive" />
                    <h5 class="shop-item-h5">${products[id].name}</h5>
                    <h3 class="shop-item-h3">$${products[id].price}</h3>
                    <button class="shop-item-button">— Add to cart</button>
                </div>`;*/
    }       